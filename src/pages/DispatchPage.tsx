        ...
        <div className="max-w-[1200px] w-full">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px' }}>
            ...
            <div style={{ display: 'flex', gap: '12px' }}>
              <button onClick={() => navigate('/analytics')} style={buttonStyle}>Analytics</button>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead>
                  <tr style={{ backgroundColor: 'rgba(255,255,255,0.04)', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
                    ...
                    <th style={{ textAlign: 'left', padding: '12px', fontFamily: '"Source Code Pro", monospace', fontSize: '13px', fontWeight: 600 }}>Current Loc.</th>
                ...
                <tbody>
                  {shipments.map((s, i) => (
                    <tr key={s.id} style={{ borderBottom: i < shipments.length - 1 ? '1px solid rgba(255,255,255,0.06)' : 'none' }}>
                      ...
                      <td style={{ padding: '12px', fontFamily: '"Source Code Pro", monospace', fontSize: '14px' }}>
                        <span style={{
                          padding: '4px 8px',
                          borderRadius: '8px',
